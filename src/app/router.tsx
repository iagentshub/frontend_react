...
const LoginPage = lazy(() =>
  import("@/routes/auth/login-page").then((module) => ({ default: module.LoginPage })),
);
const HomePage = lazy(() =>
  import("@/routes/public/home-page").then((module) => ({ default: module.HomePage })),
);
const ForgotPasswordPage = lazy(() =>
  import("@/routes/auth/forgot-password-page").then((module) => ({
    default: module.ForgotPasswordPage,
  })),
);
const ResetPasswordPage = lazy(() =>
  import("@/routes/auth/reset-password-page").then((module) => ({
    default: module.ResetPasswordPage,
  })),
);
const VerifyPage = lazy(() =>
  import("@/routes/auth/verify-page").then((module) => ({ default: module.VerifyPage })),
);
const VsCodeAuthPage = lazy(() =>
  import("@/routes/auth/vscode-auth-page").then((module) => ({ default: module.VsCodeAuthPage })),
);
...
const AgentsPage = lazy(() =>
  import("@/routes/agents/agents-page").then((module) => ({ default: module.AgentsPage })),
);
const RegisterPage = lazy(() =>
  import("@/routes/auth/register-page").then((module) => ({ default: module.RegisterPage })),
);
const PricingPage = lazy(() =>
  import("@/routes/public/pricing-page").then((module) => ({ default: module.PricingPage })),
);
const CheckoutPage = lazy(() =>
  import("@/routes/public/checkout-page").then((module) => ({ default: module.CheckoutPage })),
);
const PublicProfilePage = lazy(() =>
  import("@/routes/public/public-profile-page").then((module) => ({
    default: module.PublicProfilePage,
  })),
);
const ConnectionsPage = lazy(() =>
  import("@/routes/connections/connections-page").then((module) => ({
    default: module.ConnectionsPage,
  })),
);
const MemoryPage = lazy(() =>
  import("@/routes/memory/memory-page").then((module) => ({ default: module.MemoryPage })),
);
const KnowledgePage = lazy(() =>
  import("@/routes/knowledge/knowledge-page").then((module) => ({ default: module.KnowledgePage })),
);
const ExplorePage = lazy(() =>
  import("@/routes/explore/explore-page").then((module) => ({ default: module.ExplorePage })),
);
const LabelsPage = lazy(() =>
  import("@/routes/labels/labels-page").then((module) => ({ default: module.LabelsPage })),
);
const ManagerPage = lazy(() =>
  import("@/routes/manager/manager-page").then((module) => ({ default: module.ManagerPage })),
);
const ProfilePage = lazy(() =>
  import("@/routes/profile/profile-page").then((module) => ({ default: module.ProfilePage })),
);
const AdminPage = lazy(() =>
  import("@/routes/admin/admin-page").then((module) => ({ default: module.AdminPage })),
);
const MetadataPage = lazy(() =>
  import("@/routes/admin/metadata-page").then((module) => ({ default: module.MetadataPage })),
);
const CentinelPage = lazy(() =>
  import("@/routes/admin/centinel-page").then((module) => ({ default: module.CentinelPage })),
);
const WorkflowsPage = lazy(() =>
  import("@/routes/workflows/workflows-page").then((module) => ({ default: module.WorkflowsPage })),
);
...
export const router = createBrowserRouter([
  ...
  { path: "/checkout/", element: lazyRoute(<CheckoutPage />) },
  {
    ...
    children: [{ index: true, element: lazyRoute(<PublicProfilePage />) }],
  },
