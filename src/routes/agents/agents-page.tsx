                ...
                <div className="platform-section">
                  ...
                  {routines.map((routine, index) => (
                    <div className="routine-card" key={index}>
                      ...
                      <button type="button" className="btn-icon btn-icon--danger" title="Eliminar rutina" aria-label="Eliminar rutina" onClick={() => setRoutines((items) => items.filter((_, itemIndex) => itemIndex !== index))}><Icon kind="delete" /></button>
                    </div>
                  ))}
