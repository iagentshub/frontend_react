...
function SupportCard({
  ...
  return (
    <article className="support-channel-card">
      ...
      {to ? (
        <Link className="support-channel-action" to={to}>
          {content}
        </Link>
      ) : (
        <a
  ...
  if (kind === "docs")
    return (
      <svg viewBox="0 0 24 24" aria-hidden="true">
        <path d="M3 5a3 3 0 0 1 3-2h6v18H6a3 3 0 0 0-3 2V5zM21 5a3 3 0 0 0-3-2h-6v18h6a3 3 0 0 1 3 2V5z" />
      </svg>
    );
  if (kind === "email")
    return (
